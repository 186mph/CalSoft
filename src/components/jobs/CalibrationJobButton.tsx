...
export function CalibrationJobButton({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Explicitly exclude equipment_types and job_type to prevent database errors
      const jobData = {
      ...
      // Explicitly remove any equipment_types or job_type fields that might have been added
